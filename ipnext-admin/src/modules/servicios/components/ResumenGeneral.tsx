  ...
  return (
    <div>
      <div className="grid grid-cols-4 gap-4 mb-6">
        <KpiCard icon={<DollarSign size={20} className="text-[#E42313]" />} label="Gasto total mensual" value={`$${formatARS(resumen.gastoTotal)}`} iconBg="bg-red-50" />
          ...
          return (
            <div key={cat} className="border border-[#E8E8E8] rounded-xl p-4">
              <div className="flex justify-between items-start mb-3">
                ...
                <span className="font-bold text-[#0D0D0D]">${formatARS(total)}/mes</span>
              </div>
