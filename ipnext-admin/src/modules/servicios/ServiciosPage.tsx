...
const internetCols = [
  ...
  { key: 'monto', header: 'Monto Mensual', render: (s: Servicio) => <span className="font-semibold">${formatARS(s.montoMensual)}</span> },
...
const seguridadCols = [
  ...
  { key: 'monto', header: 'Costo Mensual', render: (s: Servicio) => <span className="font-semibold">${formatARS(s.montoMensual)}</span> },
      ...
      <Card className="p-0 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {activeTab === 'seguridad' && <ServiciosTable servicios={seguridad} kpis={[
            { icon: <DollarSign size={20} className="text-[#E42313]" />, label: 'Gasto del mes', value: `$${formatARS(seguridad.reduce((a, s) => a + (s.montoMensual ?? 0), 0))}`, iconBg: 'bg-red-50' },
          ...
          {activeTab === 'software' && <ServiciosTable servicios={software} kpis={[
            { icon: <DollarSign size={20} className="text-[#E42313]" />, label: 'Gasto del mes', value: `$${formatARS(software.reduce((a, s) => a + (s.montoMensual ?? 0), 0))}`, iconBg: 'bg-red-50' },
